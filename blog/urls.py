...
urlpatterns = [
    ...
    path('load-more-replies/<int:comment_id>', views.LoadMoreRepliesView.as_view(), name='more-replies'),
    ...
    path('delete_comment/<int:id>', views.DeleteComment.as_view(), name='delete-comment'),
